...
import {
  Body, Container, Head, Heading, Html, Preview, Section, Text, Button, Img } from 'npm:@react-email/components@0.0.22'
...
const infoBox = { backgroundColor: '#f5f0eb', padding: '20px 24px', margin: '0 0 24px', borderLeft: '4px solid #0E3D2C' }
const infoText = { margin: '4px 0', fontSize: '14px', color: '#0E3D2C' }
