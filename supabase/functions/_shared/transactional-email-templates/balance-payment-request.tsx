...
const detailLabel = { margin: '0 0 12px', fontSize: '11px', color: '#6b6b6b', textTransform: 'uppercase' as const, letterSpacing: '0.1em', fontWeight: '600' as const }
const detailRow = { margin: '0 0 6px', fontSize: '14px', color: '#555', lineHeight: '1.6' }
const balanceText = { margin: '8px 0 0', fontSize: '16px', color: '#0E3D2C', lineHeight: '1.6' }
